...
const Footer = (
  ...
  return (
      ...
      <footer className={`text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8 ${className}`}>
          <div className="max-w-lg sm:mx-auto sm:text-center ">
              
              <Logo className=" px-[30%] sm:mx-auto "/>
          ...
          <div className="mt-8 items-center justify-between sm:flex">
              <div className="mt-4 sm:mt-0">
                  &copy; 2024 MetaBlog All rights reserved.
              </div>
